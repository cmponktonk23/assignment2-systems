...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.flash_attention.flash_attention_pytorch import FlashAttention
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    from cs336_systems.flash_attention.flash_attention_triton import FlashAttention
    return FlashAttention
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    from cs336_systems.DDP.ddp_overlap_individual_parameters import DDPModuleWrapper
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.DDP.ddp_overlap_bucketed import DDPModuleWrapper
    return DDPModuleWrapper(module, bucket_size_mb)
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    from cs336_systems.DDP.optimizer_state_sharding import DDPOptimizerWrapper
    return DDPOptimizerWrapper(params, optimizer_cls, **kwargs)
